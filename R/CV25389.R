...
# credits to Marco (http://stats.stackexchange.com/users/4856/macro)

CV25389 <- function(pred_prob, truth, main = "Title"){
    ...
    box()
    legend(0,.5,col=c(2,"darkgreen",4,"darkred"),lwd=c(2,2,2,2),c("Sensitivity","Specificity","Classification Rate","Distance"))
